  ...
  return (
    <div className="min-h-screen overflow-x-clip">
      ...
      <main className="app-shell max-w-[1400px] mx-auto py-6 sm:py-8">
        ...
        >
          <h1 className="font-display text-3xl sm:text-5xl lg:text-6xl leading-[1.05] max-w-3xl">
          ...
          <p className="text-sm sm:text-base text-[var(--color-ink-soft)] mt-3 max-w-2xl">
        ...
        {/* Legend */}
        <div className="flex flex-wrap items-center gap-x-3 sm:gap-x-5 gap-y-2 mb-4 sm:mb-5 text-[11px] sm:text-xs font-mono">
          ...
          {Object.values(PROVINCES).map((p) => (
            <span key={p.code} className="flex items-center gap-1.5">
              <span
                ...
                style={{ background: p.color, outline: "1px solid rgba(26,20,16,0.4)" }}
              />
              {p.code}. {p.name}
            </span>
          ))}
        ...
        {/* Grid */}
        <div className="grid xl:grid-cols-[minmax(0,1fr)_420px] gap-4 sm:gap-6 items-start">
          {/* Map card */}
          <div className="map-frame paper relative bg-[var(--color-bg-2)] border border-[var(--color-line)] rounded-2xl p-3 sm:p-4 shadow-[0_18px_50px_-28px_rgba(26,20,16,0.4)]">
            <div className="flex flex-wrap items-center justify-between gap-2 mb-2 px-1 sm:px-2">
              <div className="font-display italic text-base sm:text-lg">
